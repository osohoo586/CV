...
- ✉ osohoo586@gmail.com
- ☎ +976 8003 7577
- ⚲ Улаанбаатар, БЗД, Монгол
- 🐙 [github.com/osohoo586](https://github.com/osohoo586)

## Tech stack

- HTML5
- Tailwind CSS (CDN)
- Vanilla JS (print trigger only)
...
CV хуудасны баруун дээд буланд **«⤓ PDF татах»** товч, эсвэл
`Ctrl + P` → "Save as PDF".
